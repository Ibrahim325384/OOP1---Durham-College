// Name: Ibrahim Khan
// Date: March 13, 2024
// Description: Program is made up of 4 classes that make up an unnamed company
// This code is copied from the Person.java file given in DC Connect as instructed by thr assignment
 ...
 * names, as well as a birthdate. This is a 'concrete' class, meaning
...
public class Person {
    ...
    private LocalDate myBirthDate; // the person's birthdate
     ...
     * @param birthDate - the intended birthdate.
    ...
    /**
     * Sets the birthdate based on a parameter. No class specific validation.
     * @param birthDate the intended birthdate
     */
